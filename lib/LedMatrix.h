...
public:
    ...
    void setPixelOnDisplayFix(byte display, byte x, byte y);
    void setByteOnDisplayFix(byte display, byte x, byte val);
    byte getColumn(byte display, byte column);
    void blitColumnMove(byte display, byte column, byte blit);
